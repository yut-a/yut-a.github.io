...
기업의 주요 재무비율 중 **안정성 지표가 좋을** 수록, 코로나 19와 같은 위기 상황에서 **낮은 주가 하락률**을 보일 가능성이 크다. 기업의 주요 재무비율 중 **안정성과 성장성 지표 모두 나쁠** 경우, 코로나 19와 같은 위기 상황에서 **높은 주가 하락률**을 보일 가능성이 크다. 따라서, 경제 위기의 상황에서 `기업`의 경우, 기업 가치 급락을 방지하기 위해 **현금성 자산, 자기자본 등 안정성 지표를 견고히 하는데 집중**해야 하며, `투자자`의 경우, 투자 포트폴리오 가치 급락을 방지하기 위해 **안정성 지표가 좋은 종목에 투자**하는 것이 바람직하다.
