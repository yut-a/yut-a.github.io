...
target은 사업보고서 공시 이후 3개월 뒤의 수익률을 산출하여 `상승`이면 `1`, `하락`이면 `0`으로 설정했다. 일반적으로, 12월 결산 사업보고서는 다음 해 3월 말 혹은 4월 초에 공시가 되기 때문에, 다음 해 4월 10일(공휴일이면 그 다음주 월요일) 가격 대비 3개월 뒤의 가격의 수익률을 산출했다.<BR/><BR/><BR/><BR/>
